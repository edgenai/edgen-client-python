...
from ._exceptions import EdgenError, APIStatusError
...
class Edgen(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Edgen client instance.

        This automatically infers the following arguments from their corresponding environment variables if they are not provided:
        - `api_key` from `EDGEN_API_KEY`
        - `organization` from `EDGEN_ORG_ID`
        """
        if api_key is None:
            api_key = os.environ.get("EDGEN_API_KEY")
        self.api_key = api_key

        if organization is None:
            organization = os.environ.get("EDGEN_ORG_ID")
    ...
    def default_headers(self) -> dict[str, str | Omit]:
        return {
            **super().default_headers,
            ...
            "Edgen-Organization": self.organization if self.organization is not None else Omit(),
...
class AsyncEdgen(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async Edgen client instance.
